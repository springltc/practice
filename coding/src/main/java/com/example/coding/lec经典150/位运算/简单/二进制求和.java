...
//            int aVal = i > lengthA - 1 ? 0 : Integer.parseInt(String.valueOf(a.charAt(lengthA - 1 - i)));
//            int bVal = i > lengthB - 1 ? 0 : Integer.parseInt(String.valueOf(b.charAt(lengthB - 1 - i)));
